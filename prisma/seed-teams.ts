...
const mlbTeams = [
  ...
  { mlbId: 109, name: "Arizona Diamondbacks", city: "Phoenix", abbreviation: "ARI", logo: "https://www.mlbstatic.com/team-logos/109.svg" },
  ...
  { mlbId: 115, name: "Colorado Rockies", city: "Denver", abbreviation: "COL", logo: "https://www.mlbstatic.com/team-logos/115.svg" },
  ...
  { mlbId: 136, name: "Mariners", city: "Seattle", abbreviation: "SEA", logo: "https://www.mlbstatic.com/team-logos/136.svg" },
  ...
  { mlbId: 140, name: "Texas Rangers", city: "Arlington", abbreviation: "TEX", logo: "https://www.mlbstatic.com/team-logos/140.svg" },
  { mlbId: 141, name: "Toronto Blue Jays", city: "Toronto", abbreviation: "TOR", logo: "https://www.mlbstatic.com/team-logos/141.svg" },
  { mlbId: 142, name: "Minnesota Twins", city: "Minneapolis", abbreviation: "MIN", logo: "https://www.mlbstatic.com/team-logos/142.svg" },
...
async function main() {
  ...
  console.log(`✅ Created ${result.count} MLB teams`);
}
